...
class BelumImunisasiFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        _imunisasiViewModel = ViewModelProvider(
            this,
            ViewModelFactory.ImunisasiViewModelFactory(requireActivity().applicationContext)
    ...
    private fun getImunisasiNotDoneResponse() {
        imunisasiViewModel.getImunisasiNotDoneResponse("anak1").observe(this) { resultResponse ->
            when (resultResponse) {
